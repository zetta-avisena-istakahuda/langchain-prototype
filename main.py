...
def initRAG(vector_store):
 if 'code_executed' not in st.session_state:
  ...
  retriever = vector_store.as_retriever(search_type='similarity_score_threshold', search_kwargs={"score_threshold": 0.9, "k":3}, filters={'metadata': {'source': 'emarketing_textbook_download_chunk_recursive'}})
